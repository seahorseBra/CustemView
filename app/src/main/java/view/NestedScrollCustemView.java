...
public class NestedScrollCustemView extends LinearLayout implements NestedScrollingParent {
    private static final String TAG = "NestedScrollCustemView";
    ...
    public NestedScrollCustemView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    protected void onFinishInflate()
    {
        ...
        mNav = findViewById(R.id.stickynavlayout_indicator);
